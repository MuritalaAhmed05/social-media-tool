            ...
            <CardDescription>
              <Tabs defaultValue="Tiktok Downloader" className="w-full">
                <TabsList className="grid w-full grid-cols-3">
                  <TabsTrigger value="Tiktok Downloader">
                    Tiktok Downloader
                  </TabsTrigger>
            ...
            <CardDescription>
              <Tabs defaultValue="Instagram Downloader" className="w-full">
                <TabsList className="grid w-full">
                  <TabsTrigger value="Instagram Downloader">
          ...
          <CardHeader>
            ...
            <CardDescription>
              <Tabs defaultValue="X Downloader" className="w-full">
                <TabsList className="grid w-full">
                  <TabsTrigger value="X Downloader" className="w-full">
                    X Downloader
                  </TabsTrigger>
                  {/* <TabsTrigger value="Instagram Stalk">Instagram Stalk</TabsTrigger> */}
                </TabsList>
          ...
          <CardHeader>
            ...
            <CardDescription>
              <Tabs defaultValue="YouTube Downloader" className="w-full">
                <TabsList className="grid grid-cols-2 md:grid-cols-6 grid-rows-3 gap-9 mb-[5rem] sm:mb-0 p-5">
                  <TabsTrigger value="YouTube Downloader">
                    YouTube Downloader
                  </TabsTrigger>
                  <TabsTrigger value="MusicSearch">
                    Youtube Music Search
                  </TabsTrigger>
                  <TabsTrigger value="YouTube Music Album">
                    YouTube Music Album
                  </TabsTrigger>
                  <TabsTrigger value="To Mp3">To Mp3</TabsTrigger>
                  <TabsTrigger value="To Mp4">To Mp4</TabsTrigger>
                  <TabsTrigger value="YouTube Search">
                    YouTube Search
                  </TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="MusicSearch">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Make changes to your YouTube Downloader here. Click save
                        when you're done.
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-2">
          ...
          <CardHeader>
            ...
            <CardDescription>
              <Tabs defaultValue="FaceBook Downloader" className="w-full">
                <TabsList className="grid w-full">
                  <TabsTrigger value="FaceBook Downloader" className="w-full">
                    FaceBook Downloader
                  </TabsTrigger>
                  {/* <TabsTrigger value="Instagram Stalk">Instagram Stalk</TabsTrigger> */}
                </TabsList>
            ...
            <CardDescription>
              <Tabs defaultValue="Spotify Downloader" className="w-full">
                <TabsList className="grid w-full grid-cols-2">
                  <TabsTrigger value="Spotify Downloader">
                    Spotify Downloader
                  </TabsTrigger>
                  <TabsTrigger value="Spotify Search">
                    Spotify Search
                  </TabsTrigger>
                </TabsList>
                <TabsContent value="Spotify Downloader">
                  ...
                  <Tabs defaultValue="Spotify Downloader" className="w-full">
                    <TabsList className="grid w-full grid-cols-3">
                      ...
                      <TabsTrigger value="Spotify Playlist">
                        Spotify Playlist
                      </TabsTrigger>
                      <TabsTrigger value="Spotify Album">
                        Spotify Album
                      </TabsTrigger>
                    </TabsList>
                    <TabsContent value="Spotify Downloader">
                      <Card>
                        <CardHeader>
                          <CardTitle>Spotify Downloader</CardTitle>
                          <CardDescription>
                            Change your Spotify Downloader here. After saving,
                    ...
                    <TabsContent value="Spotify Playlist">
                      <Card>
                        <CardHeader>
                          ...
                          <CardDescription>
                            Change your Spotify Playlist here. After saving,
                            you'll be logged out.
                          </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-2">
                    ...
                    <TabsContent value="Spotify Album">
                      <Card>
                        <CardHeader>
                          ...
                          <CardDescription>
                            Change your Spotify Album here. After saving, you'll
                            be logged out.
                          </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-2">
                    ...
                    <TabsContent value="Spotify Search">
                      <Card>
                        <CardHeader>
                          <CardTitle>Spotify Search</CardTitle>
                          <CardDescription>
                            Make changes to your Spotify Search here. Click save
                            when you're done.
                          </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-2">
                    ...
                    <TabsContent value="Spotify Playlist">
                      <Card>
                        <CardHeader>
                          <CardTitle>Spotify Playlist</CardTitle>
                          <CardDescription>
                            Change your TikTok Search here. After saving, you'll
                            be logged out.
                          </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-2">
